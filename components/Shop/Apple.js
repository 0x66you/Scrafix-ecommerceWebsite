    ...
    <div>
        <div class="row">
            <div class="col-lg-auto order-xl-1">
                <mainpart named="Apple"
                          img1="./components/images/Apple/appleCover.png"
                          img2="./components/images/Apple/appleCover2.png"
                          img3="./components/images/Apple/appleCover3.png">                          
                </mainpart>
            </div>
